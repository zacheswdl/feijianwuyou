...
const PlanForm = ({ visible, record, mode, onCancel, onSave }: PlanFormProps) => {
  ...
  const getTitle = () => {
    switch (mode) {
      case 'add': return '新增计划';
      case 'edit': return '编辑计划';
      case 'view': return '查看计划';
      default: return '计划详情';
    }
  };
        ...
        >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            <Form.Item
              label="所属年份"
              name="year"
              rules={[{ required: true, message: '请输入所属年份' }]}
            >
            ...
            >
              <Select placeholder="请选择计划类型">
                ...
                <Option value="功能性检查">功能性检查</Option>
              </Select>
            </Form.Item>
          </div>
